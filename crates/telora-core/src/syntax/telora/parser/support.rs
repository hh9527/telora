...
impl<'a> ParserCallbacks<'a> for Parser<'a> {
    ...
    fn predicate_let_binding_1(&self) -> bool {
        // Only distinguish a binding name from a constructor-pattern head.
        // The initializer and optional else are parsed by the grammar.
        !matches!(self.peek(1), Token::LParen | Token::Dot)
    }
