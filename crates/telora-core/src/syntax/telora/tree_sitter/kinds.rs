...
fn named_rules(name: &str) -> Option<&'static [Rule]> {
    Some(match name {
        ...
        "export_item" => &[Rule::ExportItem],
        "export_items" => &[Rule::ExportItems],
        "export_statement" => &[Rule::ExportStatement],
        ...
        "import_binding" => &[Rule::ImportBinding],
        "import_item" => &[Rule::ImportItem],
        "import_items" => &[Rule::ImportItems],
        "import_selector" => &[Rule::ImportSelector],
