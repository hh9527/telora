struct GenericInference<'a> {
    ...
    local_type_properties: Vec<TypePropertyEvidence>,
    property_contracts: HashMap<crate::Location, TypeDescriptor>,
    trait_ids: &'a BTreeMap<String, crate::TraitId>,
    display_trait: Option<(crate::TraitId, String)>,
    resolved_trait_members: HashMap<crate::Location, ResolvedEvidence>,
    resolved_call_evidence: HashMap<crate::Location, Vec<ResolvedEvidence>>,
    resolved_interpolation_evidence: HashMap<crate::Location, ResolvedEvidence>,
    pending_interpolations: Vec<PendingInterpolation>,
    runtime_type_evidence: BTreeMap<String, TypeDescriptor>,
    lexical_type_evidence: Vec<LexicalTypeEvidence>,
    hir: &'a HirProgram,
