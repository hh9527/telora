...
pub(crate) fn run(context: PathBuf, arguments: EvalArgs) -> Result<i32, String> {
    ...
    crate::wasm_cli::eval(context, &arguments.selector.module_id, &arguments.selector.export)
}
...
pub(crate) fn run_with(context: PathBuf, arguments: EvalWithArgs) -> Result<i32, String> {
    ...
    crate::wasm_cli::eval_with(context, &arguments.selector.module_id, &arguments.selector.export, arguments.sources, arguments.args)
}
